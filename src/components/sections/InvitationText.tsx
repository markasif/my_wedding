...
export function InvitationText() {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto text-center px-6 md:px-12">
        ...
        <motion.div
           ...
           className="mb-2 md:mb-4 lg:mb-6"
        >
          <p className="font-serif italic text-text-muted text-lg md:text-2xl leading-relaxed max-w-2xl mx-auto px-4 opacity-80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2 md:mb-4 lg:mb-6 relative">
          ...
          >
            <div className="relative p-6 md:p-8 lg:p-10 xl:p-12 w-full h-full border border-gold/15 bg-white/40 royal-shadow paper-texture rounded-sm flex flex-col group overflow-hidden">
               ...
               <div className="relative">
                 <span className="inline-block px-4 py-1 border border-gold/30 text-[10px] tracking-[0.6em] uppercase text-gold font-bold mb-6 bg-white/80 shadow-sm">Groom</span>
               </div>
               
               {/* Name */}
               <h3 className="font-serif text-3xl md:text-5xl font-bold text-burgundy tracking-tight mb-6 relative">
                 Mohammed Asif
               </h3>

               {/* Parents */}
               <div className="space-y-3 mb-6 flex-grow flex flex-col justify-center relative">
                  <span className="font-script text-2xl text-gold-muted leading-none block">Son of</span>
                  <div className="space-y-1">
                    <p className="font-serif text-dark-mid text-lg md:text-xl font-bold uppercase tracking-wide">Mr. Mohamed Aliparambil</p>
                    <p className="font-serif italic text-gold-muted py-1 opacity-60 text-lg">&amp;</p>
                    <p className="font-serif text-dark-mid text-lg md:text-xl font-bold uppercase tracking-wide">Mrs. Ayishabeevi Valiyapeediyekkal</p>
                  </div>
               </div>

               {/* Address */}
               <div className="pt-6 border-t border-gold/10 mt-auto relative">
                  <p className="font-sans text-[11px] text-text-muted tracking-[0.2em] uppercase leading-relaxed max-w-[280px] mx-auto font-medium">
          ...
          >
            <div className="relative p-6 md:p-8 lg:p-10 xl:p-12 w-full h-full border border-gold/15 bg-white/40 royal-shadow paper-texture rounded-sm flex flex-col group overflow-hidden">
               ...
               {/* Label */}
               <div className="relative">
                 <span className="inline-block px-4 py-1 border border-gold/30 text-[10px] tracking-[0.6em] uppercase text-gold font-bold mb-6 bg-white/80 shadow-sm">Bride</span>
               </div>
               ...
               {/* Parents */}
               <div className="space-y-3 mb-6 flex-grow flex flex-col justify-center relative">
                  <span className="font-script text-2xl text-gold-muted leading-none block">Daughter of</span>
                  <div className="space-y-1">
                    <p className="font-serif text-dark-mid text-lg md:text-xl font-bold uppercase tracking-wide">Mr. Mohammed KP</p>
                    <p className="font-serif italic text-gold-muted py-1 opacity-60 text-lg">&amp;</p>
                    <p className="font-serif text-dark-mid text-lg md:text-xl font-bold uppercase tracking-wide">Mrs. Hajara Mohammed</p>
                  </div>
               </div>

               {/* Address */}
               <div className="pt-6 border-t border-gold/10 mt-auto relative">
                  <p className="font-sans text-[11px] text-text-muted tracking-[0.2em] uppercase leading-relaxed max-w-[320px] mx-auto font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2 md:mb-4 lg:mb-6 relative">
          ...
          <motion.div
            ...
            className="flex flex-col items-center h-full"
          >
            <div className="relative p-6 md:p-8 bg-white/60 backdrop-blur-sm border border-gold/20 royal-shadow paper-texture rounded-sm w-full h-full flex flex-col items-center justify-center group overflow-hidden">
               ...
               <div className="mt-4 text-center">
                  <span className="font-script text-2xl text-gold block mb-1">Venue Location</span>
          ...
          >
            <div className="relative p-6 md:p-8 bg-white/60 backdrop-blur-sm border border-gold/20 royal-shadow paper-texture rounded-sm w-full h-full flex flex-col items-center justify-center group overflow-hidden">
               ...
               <p className="font-script text-2xl text-gold mb-4 leading-none text-center">Sharing Love & Happiness</p>
               
               <div className="flex flex-col items-center gap-2 w-full">
                  <p className="font-serif text-xl md:text-2xl font-bold text-burgundy tracking-tight">Fathima Rinfa</p>
                  <span className="font-script text-2xl text-gold opacity-50">&amp;</span>
                  <p className="font-serif text-xl md:text-2xl font-bold text-burgundy tracking-tight">Fathima Rena</p>
               </div>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="pt-8"
        >
          <p className="font-serif italic text-xl text-text-muted mb-6 max-w-2xl mx-auto px-6 opacity-80 leading-relaxed">
